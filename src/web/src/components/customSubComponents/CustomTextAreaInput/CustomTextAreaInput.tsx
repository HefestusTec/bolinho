...
import styleModule from "./CustomTextAreaInput.module.css";

interface CCustomTextAreaInputProps {
...
const CustomTextAreaInput: FunctionComponent<CCustomTextAreaInputProps> = ({
    inputType = "text",
    title,
    value,
    setValue,
